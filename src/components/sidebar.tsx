...
export default function Sidebar() {
    ...
    return (
        <aside className="fixed top-0 left-0 z-40 w-64 h-screen pt-6 pb-4 px-2 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-darkPrimary dark:border-gray-600">
            <div className="flex justify-center mb-6">
                <h1 className="font-bold font-sans text-2xl">Catat.in</h1>
            </div>
            <div className="relative h-full overflow-y-auto overflow-x-hidden">
                <ul className="space-y-2 font-medium">
                    <Link href="/" className={`flex items-center p-2 rounded-lg pl-8 text-slate-500 hover:bg-gray-50 dark:hover:bg-gray-900 ${pathname == "/" ? "font-semibold text-slate-800 bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-800" : "text-gray-900"}`}>
                    ...
                    <Link href="/favorites" className={`flex items-center p-2 rounded-lg pl-8 text-slate-500 hover:bg-gray-50 dark:hover:bg-gray-900 ${pathname == "/favorites" ? "font-semibold text-slate-800 bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-800" : "text-gray-900"}`}>
                    ...
                    <Link href="/archives" className={`flex items-center p-2 rounded-lg pl-8 text-slate-500 hover:bg-gray-50 dark:hover:bg-gray-900 ${pathname == "/archives" ? "font-semibold text-slate-800 bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-800" : "text-gray-900"}`}>
